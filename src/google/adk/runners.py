...
class Runner:
  ...
  def _new_invocation_context(
    ...
    Args:
        ...
        auth_token: The authentication token for the context.
    ...
    # Configure authentication if a token is provided
    ...
    if auth_token:
      ...
      requested_auth_configs = {
          "bearer": AuthCredential(
              auth_type=AuthCredentialTypes.HTTP,
              http=HttpAuth(
                  scheme="bearer",
                  credentials=HttpCredentials(token=auth_token)
              )
          )
      }
