...
class TranscriptionManager:
  ...
  async def handle_input_transcription(
    ...
    Args:
      ...
      llm_response: The LLM response containing input transcription.
    """
  ...
  async def handle_output_transcription(
    ...
    Args:
      invocation_context: The current invocation context.
      llm_response: The LLM response containing output transcription.
    """
    return await self._create_and_save_transcription_event(
        invocation_context=invocation_context,
  ...
  async def _create_and_save_transcription_event(
    ...
    Args:
      ...
      partial: Whether this is a partial transcription.
      content: Optional content to include with the transcription event.
    """
    try:
