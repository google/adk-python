...
_ALLOWED_GLOBALS: dict[str, set[str]] = {
    "builtins": {
        "dict", "list", "set", "tuple", "frozenset", "bytes",
        "bytearray", "True", "False", "None", "type", "object",
        "complex", "slice", "range", "int", "float", "str", "bool",
    },
...
class _RestrictedUnpickler(pickle.Unpickler):
    ...
    def find_class(self, module: str, name: str) -> Any:
        ...
        raise pickle.UnpicklingError(
            ...
            f"If this is a legitimate ADK type, please file an issue at "
            f"https://github.com/google/adk-python/issues"
        )
