...
class VertexAiSessionService(BaseSessionService):
  ...
  async def clone_session(
    ...
    if new_session_id:
      raise ValueError(
          'User-provided session id (new_session_id) is not supported for'
          ' VertexAISessionService. The session ID is auto-generated by the'
          ' Vertex AI backend.'
      )
    ...
    # Create the new session (ID is auto-generated by Vertex AI backend)
    ...
    # Return the new session with events (already populated via append_event)
