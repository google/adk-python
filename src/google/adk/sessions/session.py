...
class ExitResponse(BaseModel):
    """
    A response indicating the agent should exit.

    This is used to signal that the agent has completed its task and should exit.

    Attributes:
        reason: The reason for exiting
        data: Optional additional data to include with the exit response
    """
