...
> **Tip:** The OpenAI Python client also honors the `OPENAI_BASE_URL` environment
> variable, so an OpenAI-compatible multi-model gateway can be pointed at without
> constructing a client — for example [DaoXE](https://daoxe.com) at
> `https://api.daoxe.com/v1`.
