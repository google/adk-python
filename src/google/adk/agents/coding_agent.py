...
from ..telemetry.tracing import trace_code_execution
...
"""
    ...
    async def _run_async_impl(
        ...
        while iteration < self.max_iterations:
            ...
            event_id = f"coding_agent_llm_{uuid.uuid4().hex[:8]}"

            # Call the model with tracing (generate_content_async returns an async generator)
            llm_response = None
            ...
            with tracer.start_as_current_span("execute_code"):
                ...
                trace_code_execution(
                    ...
                    success=not self._is_real_error(
                        exec_result.code_result.stderr or ""
                    ),
