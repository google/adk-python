  ...
  - generic [ref=e3]:
    - generic [ref=e4]:
      ...
      - generic [ref=e7]:
        ...
        - button "What tables are available in the database?" [active] [ref=e14] [cursor=pointer]:
        ...
        - generic [ref=e97]: "Session: 23ace895..."
        ...
        - generic [ref=e422]:
          ...
          - tabpanel "Security Chat" [ref=e445]:
            - generic [ref=e446]:
              ...
              - generic [ref=e455]:
                - textbox "Ask about your GCP security posture..." [ref=e458]
                - button [disabled] [ref=e459]:
                  - img [ref=e460]
        - separator [ref=e466]
        - generic [ref=e471]: 🔐 GCP Security Executive Dashboard | Powered by Vertex AI & ADK | Real-time streaming with SQLite integration | MSA Impact Analysis | Service Evaluation Framework | Agent Quality Assurance
  - img [ref=e472]
```