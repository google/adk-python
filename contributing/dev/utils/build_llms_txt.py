...
def normalize_adk_python_readme(md: str) -> str:
  ...
  return (
      ...
      .replace(
          ...
          "https://github.com/a2aproject/a2a-samples/tree/main/samples/python/agents",
      )
      .replace(
          "https://github.com/a2aproject/a2a-samples/tree/main/samples/python/agents/google_adk",
          "https://github.com/a2aproject/a2a-samples/tree/main/samples/python/agents",
      )
  )
