...
async def test_include_contents_none_with_fallback():
    ...
    # Use actual dict instead of MagicMock for proper serialization testing
    mock_response = {
        "choices": [{
            "message": {
...
async def test_include_contents_none_with_tools():
    ...
    # Create proper tool call object for realistic testing
    ...
    # Use actual dict response structure
    mock_response = {
        "choices": [{
            "message": {
                "content": None,
