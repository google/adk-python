...
class TestGcpUtils(unittest.TestCase):
  ...
  @mock.patch("google.auth.default")
  def test_get_gcloud_project_success(self, mock_auth_default):
    mock_auth_default.return_value = (mock.Mock(), "my-project")
    self.assertEqual(gcp_utils._get_gcloud_project(), "my-project")

  @mock.patch("google.auth.default")
  def test_get_gcloud_project_unset(self, mock_auth_default):
    mock_auth_default.return_value = (mock.Mock(), None)
    self.assertIsNone(gcp_utils._get_gcloud_project())

  @mock.patch("google.adk.cli.utils.gcp_utils.AuthorizedSession")
  @mock.patch("google.auth.default")
  @mock.patch("google.adk.cli.utils.gcp_utils._get_gcloud_project")
  def test_retrieve_express_project_success(
      self, mock_get_project, mock_auth_default, mock_session_cls
  ):
  ...
  @mock.patch("google.auth.default")
  @mock.patch("google.adk.cli.utils.gcp_utils._get_gcloud_project")
  def test_check_express_eligibility(
      self, mock_get_project, mock_auth_default, mock_session_cls
  ):
    mock_auth_default.return_value = (mock.Mock(), "test-project-id")
    mock_get_project.return_value = "test-project-id"
