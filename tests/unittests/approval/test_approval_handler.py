...
class TestGetPendingChallenges:
  ...
  def test_allow_when_no_policies(
      self, mock_state, function_call_id
  ):
  ...
  def test_allow_when_all_actions_granted(
    ...
    # Add grant to state
    mock_state["approvals"] = {"grants": [allow_grant]}
  ...
  def test_deny_when_any_action_denied(
    ...
    # Add grants to state
    mock_state["approvals"] = {"grants": [allow_grant, deny_grant]}
  ...
  def test_with_wildcard_resources(
    ...
    # Add grant to state
    mock_state["approvals"] = {"grants": [wildcard_grant]}
  ...
  @pytest.mark.parametrize("function_call_actor_id", [
