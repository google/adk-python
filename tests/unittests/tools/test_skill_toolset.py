...
def mock_skill1(mock_skill1_frontmatter):
  ...
  skill.source_path = "/path/to/skill1/SKILL.md"
...
@pytest.mark.asyncio
async def test_process_llm_request_no_inject(
    mock_skill1, tool_context_instance
):
  toolset = skill_toolset.SkillToolset([mock_skill1], inject_instruction=False)
  llm_req = mock.create_autospec(llm_request_model.LlmRequest, instance=True)
