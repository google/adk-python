...
@pytest.mark.asyncio
async def test_disable_google_llm_telemetry(
    monkeypatch, context_manager_with_span
):
...
@pytest.mark.asyncio
async def test_enable_google_llm_telemetry(
    monkeypatch, context_manager_with_span
):
  monkeypatch.setenv("OTEL_SDK_DISABLED", "false")
  monkeypatch.setenv("ADK_TELEMETRY_DISABLED", "false")
