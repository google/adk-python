...
def test_extra_field_allowed():
  fm = models.Frontmatter(
      name="my-skill", description="desc", unknown_field="value"
  )
...
# --- source_path on Skill ---


def test_skill_source_path():
...
def test_skill_source_path_default_none():
  fm = models.Frontmatter(name="my-skill", description="desc")
  skill = models.Skill(frontmatter=fm, instructions="do this")
