...
from google.adk.labs.openai_responses._openai_responses_llm import _content_to_response_input_items
from google.adk.labs.openai_responses._openai_responses_llm import _function_declaration_to_response_tool
from google.adk.labs.openai_responses._openai_responses_llm import _response_to_llm_response
from google.adk.labs.openai_responses._openai_responses_llm import AzureOpenAIResponsesLlm
from google.adk.labs.openai_responses._openai_responses_llm import OpenAIResponsesLlm
...
def test_azure_client_uses_openai_v1_base_url():
  ...
  with mock.patch(
      'google.adk.labs.openai_responses._openai_responses_llm.AsyncOpenAI'
  ) as client_cls:
