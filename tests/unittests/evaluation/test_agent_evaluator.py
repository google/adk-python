...
@pytest.mark.asyncio
@pytest.mark.parametrize("use_live", [True, False])
async def test_get_eval_results_by_eval_id_threads_use_live(use_live, mocker):
  """`use_live` is forwarded to the InferenceRequest's InferenceConfig."""
  ...
  assert inference_request.inference_config.use_live is use_live
