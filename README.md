...
Define a multi-agent system with a coordinator agent, greeter agent, and task execution agent. Then ADK and the model will guide the agents to work together to accomplish the task.
