...
For remote agent-to-agent communication, ADK integrates with the [A2A protocol](https://github.com/google/A2A/tree/main). See this [example](https://github.com/google/A2A/tree/main/samples/python/agents/google_adk) for how they can work together.
