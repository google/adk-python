...
async def monitor_video_stream(     
  ...
  client = Client() # removed:  Client(vertexai=False)
  prompt_text = (
  ...
  while True:
    ...
    if last_valid_req is not None:
      ...
      response = client.models.generate_content(
          model= "gemini-2.0-flash-live-preview-04-09", #"gemini-2.0-flash-live-001", #"gemini-2.0-flash-exp",
          contents=contents,
...
root_agent = Agent(
    ...
    instruction="""
      You are a monitoring agent. You can do video monitoring and
