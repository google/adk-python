...
* add skill lifecycle modes and an active-skill cap to SkillToolset ([43b73e4](https://github.com/google/adk-python/commit/43b73e4fc0920c08693bcec3985c832c7d9870b0))
...
* **context:** add abort_signal support to InvocationContext and Context ([d99b23f](https://github.com/google/adk-python/commit/d99b23fbf1dc32383f88708f3b84453dde97897f))
* drop an unloaded skill's instructions from later requests ([accb906](https://github.com/google/adk-python/commit/accb906eac1534e4cc8ba66a7b2d5a389996522b))
...
* **samples:** add ADK LlmAgent root with an AntigravityAgent sub-agent ([c803f88](https://github.com/google/adk-python/commit/c803f88b54bd7918ff8ff60eca351ae850fbd0d4))
* **samples:** add ADK Workflow with LlmAgent and AntigravityAgent nodes ([5dbe1b9](https://github.com/google/adk-python/commit/5dbe1b907a98253ba0725110fb8864a04316640c))
* **samples:** add AntigravityAgent root with an ADK LlmAgent sub-agent ([79ac8cf](https://github.com/google/adk-python/commit/79ac8cfcac0e81df3c3758d615dd21cdf10f7d9b))
* **scripts:** enforce the new-file rules on pull requests ([5dfa1e7](https://github.com/google/adk-python/commit/5dfa1e7c14512498bf8f291b45e094c4f2b5d89c))
...
* **bigquery:** restore get_bigquery_skill by moving it into integrations ([dced328](https://github.com/google/adk-python/commit/dced32859fc27bc60a3eaf70497776cc53c095c4))
...
* isolate mock session payloads in Vertex AI session service tests ([cb87541](https://github.com/google/adk-python/commit/cb87541c4eb223309b9ee6d1c71f168f2057f5cf))
...
* keep the unknown step delta test passing on google-genai 2.25 ([fa9dc02](https://github.com/google/adk-python/commit/fa9dc026db09bba8dd24c9ddf14d5ee2087b4e15))
...
* **scripts:** read the waiver from the same change as the added files ([4a2d289](https://github.com/google/adk-python/commit/4a2d2893ab8c33fcb22bfa721f6397a48d78018e))
...
* **tests:** remove redundant blank line in BQAA ([7f6e73e](https://github.com/google/adk-python/commit/7f6e73e2914df53f6c4b12c8d3332f3746034a06))
...
* update multimodal tool results plugin import for relocated tool caller ([ac0133a](https://github.com/google/adk-python/commit/ac0133a4643c6f9f1fe1e0c163d9c6d9aedd0e01))
...
* validate and coerce function tool argument types ([24b37e1](https://github.com/google/adk-python/commit/24b37e1716582bd3e6b0d27d142f70707d960bb4)), closes [#4612](https://github.com/google/adk-python/issues/4612)
...
* **workflow:** update adk-architecture skill and unit guides ([f7a1cd4](https://github.com/google/adk-python/commit/f7a1cd45e57a97d974eed994ac59040caaf3cbbe))
